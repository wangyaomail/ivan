...
public class MyFastJsonConverter extends FastJsonHttpMessageConverter {
    protected static final Logger logger = LoggerFactory.getLogger(MyFastJsonConverter.class);
    ...
    protected Object readInternal(Class<? extends Object> clazz,
        ...
        ByteArrayOutputStream baos = cloneInputStream(inputMessage.getBody());
