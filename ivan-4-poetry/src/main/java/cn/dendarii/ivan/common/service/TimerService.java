...
import cn.dendarii.ivan.util.file.MyTimeUtil;
import lombok.Data;
...
public class TimerService {
    ...
    public void resetMinClock() {
        ...
        now_to_min = MyTimeUtil.getStringFromFreq(nowTime, "minute");
        las_to_min = MyTimeUtil.getStringFromFreq(nowTime - 60l * 1000, "minute");
        nxt_to_min = MyTimeUtil.getStringFromFreq(nowTime + 60l * 1000, "minute");
    ...
    public void resetHourClock() {
        long nowTime = System.currentTimeMillis();
        now_to_hour = MyTimeUtil.getStringFromFreq(nowTime, "hour");
        las_to_hour = MyTimeUtil.getStringFromFreq(nowTime - 60l * 60 * 1000, "hour");
        nxt_to_hour = MyTimeUtil.getStringFromFreq(nowTime + 60l * 60 * 1000, "hour");
        now_to_timestamp = nowTime;
    }
    ...
    public void resetDayClock() {
        long nowTime = System.currentTimeMillis();
        now_to_day = MyTimeUtil.getStringFromFreq(nowTime, "day");
        las_to_day = MyTimeUtil.getStringFromFreq(nowTime - 24l * 3600 * 1000, "day");
        la3_to_day = MyTimeUtil.getStringFromFreq(nowTime - 24l * 3600 * 1000 * 2, "day");
        la4_to_day = MyTimeUtil.getStringFromFreq(nowTime - 24l * 3600 * 1000 * 3, "day");
        nxt_to_day = MyTimeUtil.getStringFromFreq(nowTime + 24l * 3600 * 1000, "day");
        now_to_timestamp = nowTime;
    }
}
