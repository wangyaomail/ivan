package cn.dendarii.ivan.util.algo.nlp.util;
...
public class WordAlert {
     ...
     * @return
     */
    public static String alertEnglish(char[] chars,
                                      int start,
                                      int end) {
    ...
    public static String alertEnglish(String temp,
                                      int start,
                                      int end) {
        char c = 0;
        char[] result = new char[end];
    ...
    public static String alertNumber(char[] chars,
                                     int start,
                                     int end) {
        char[] result = new char[end];
        char c = 0;
    ...
    public static String alertNumber(String temp,
                                     int start,
                                     int end) {
        char[] result = new char[end];
        char c = 0;
    ...
    public static boolean isEnglish(String word) {
        ...
        for (int i = 0; i < length; i++) {
            c = word.charAt(i);
            if ((c >= 'a' && c <= 'z') || (c >= MIN_LOWER && c <= MAX_LOWER)
                    || (c >= MIN_UPPER && c <= MAX_UPPER)
    ...
    public static boolean isEnglish(char c) {
        return (c >= 'a' && c <= 'z') || (c >= MIN_LOWER && c <= MAX_LOWER)
                || (c >= MIN_UPPER && c <= MAX_UPPER) || (c >= MIN_UPPER_E && c <= MAX_UPPER_E);
    }
