package cn.dendarii.ivan.util.encrypt.coder;
...
public class Hex {
     ...
     */
    private static final char[] DIGITS_LOWER = { '0',
                                                 '1',
                                                 '2',
                                                 '3',
                                                 '4',
     ...
     * Used to build output as Hex
     */
    private static final char[] DIGITS_UPPER = { '0',
                                                 '1',
                                                 '2',
                                                 '3',
                                                 '4',
     ...
     * @throws Exception Thrown if an odd number of characters is supplied to this
     *         function
     * @see #decodeHex(char[])
     */
     ...
     * @param object A String or, an array of character bytes containing hexadecimal
     *        digits
     * @return A byte array containing binary data decoded from the supplied byte
     *         array (representing characters).
     * @throws Exception Thrown if an odd number of characters is supplied to this
     ...
     * with the charset named by {@link #getCharsetName()}.
     * </p>
     * @param array a byte[] to convert to Hex characters
     * @return A byte[] containing the bytes of the hexadecimal characters
     * @throws IllegalStateException if the charsetName is invalid. This API throws
     *         {@link IllegalStateException} instead of {@link Exception} for
    ...
    public Object encode(Object object) throws Exception {
        try {
            byte[] byteArray = object instanceof String
                    ? ((String) object).getBytes(getCharsetName())
                    : (byte[]) object;
