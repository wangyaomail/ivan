package cn.dendarii.ivan.util.algo;
...
public class HBMathUtil {
    ...
    public static double calFreshness(long currentTime,
                                      long tarTime) {
        int dayDelay = MyTimeUtil.getTimeNumBetweenTwoTime(tarTime, currentTime, 1);
        int hourDelay = MyTimeUtil.getTimeNumBetweenTwoTime(tarTime, currentTime, 2);
        int minDelay = MyTimeUtil.getTimeNumBetweenTwoTime(tarTime, currentTime, 3);
